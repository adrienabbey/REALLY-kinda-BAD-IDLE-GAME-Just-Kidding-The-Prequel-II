...
class Monster extends GameCharacter {
    ...
    public Monster(MonsterName name) {
        ...
        switch (name) {
            ...
            case HOBOGOBLIN:
                this.setName(
                        "Not a hobgoblin. A hobo goblin. This goblin is obviously suffering after becoming emancipated from from all its wealth, health, and home.  Also, it has googley eyes.");
                this.setMuscle(4);
                this.setBrain(4);
                this.setHeart(4);
                break;
